...
pnpm start_player                # Dev server with player role (gmMode=false)
pnpm start_gm                    # Dev server with GM role (gmMode=true)
pnpm run build                    # Production build
pnpm run buildci                  # Build with CI=false (suppresses warning failures)
