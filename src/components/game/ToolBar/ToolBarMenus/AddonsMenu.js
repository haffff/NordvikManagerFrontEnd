...
export const AddonsMenu = ({ state, gameDataManagerRef }) => {
    return (
        <DropDownMenu name="Addons" width={150} >
            <DropDownMenu name="Addons" submenu={true} width={150} expandableLocationName={"addons"} expandableWithAction={true} state={state} gameDataRef={gameDataManagerRef}>
            ...
            <DropDownMenu name="Views" submenu={true} width={150} expandableLocationName={"addons"} expandableWithAction={true} state={state} gameDataRef={gameDataManagerRef}>
            ...
            <DropDownMenu name="Code" submenu={true} width={150} expandableLocationName={"addons"} expandableWithAction={true} state={state} gameDataRef={gameDataManagerRef}>
