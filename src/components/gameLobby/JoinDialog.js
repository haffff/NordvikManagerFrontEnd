...
import { Stack, Heading, Input, Button, Modal, ModalBody, useDisclosure, ModalHeader, ModalOverlay, ModalContent, Dialog } from '@chakra-ui/react'
...
export const JoinDialog = ({ OnSuccess }) => {
    ...
    const onFormSubmit = (customObj) => {
        ...
        }, (result) => { setError(true); toaster.create(UtilityHelper.GenerateJoinProblemToast());})
    }
